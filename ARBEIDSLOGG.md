...
## 21.09.2026 – magasin og utveksling

- Moxnes-video (Facebook-reel): bildetekst hentet, videoen selv ikke tilgjengelig. To påstander: forbruk ikke over 2021; lave magasiner skyldes eksport.
- s21_magasin_eksport.py: NVE magasinstatistikk (API, 1995–uke 37 2026, data/raw/nve_magasin_*.json), Statnett driftsdata produksjon/forbruk 2021–2026 og utveksling 2025–2026 (data/raw/statnett/; utvekslingsfilene 2021–2024 er nullrader hos Statnett), SSB 14091 fra s17. Endepunkt funnet via Download-app.js: restapi/download/{productionconsumption|physicalflow}/{år}?fileFormat=csv. Kontroll Statnett mot SSB: snitt avvik 6 GWh/mnd.
- Funn: magasiner uke 37 2026 16 TWh under median, NO2 under NVE-min; nettoeksport jan–jul 2026 2,7 TWh mot snitt 10,4, nettoimport feb–apr; forbruk +4,7 TWh, produksjon −3,0. Vurdering i notat/MAGASIN_EKSPORT_2026-09-21.md. Tall til godkjenning. Ikke hentet: NVE tilsig.
- Tilsig: NVE Kraftsituasjonen veke 37 2026 og 2025 (pdf + tekstuttrekk i data/raw/nve_kraftsituasjonen/), tabell 4 og 5 → output/tab_tilsig_uke37.csv. Sør-Norge uke 1–37 2026: tilsig 55,7 TWh (−12,7 mot snitt), 2025 66,0 (−3,0); hydrologisk balanse Sør −15,4 mot −3,8. Notatet oppdatert med avsnittet Tilsig; vurdering: lite tilsig er hovedforklaringen, høyere forbruk dernest, eksporten trekker motsatt.
- Metodebeskrivelse til leserinnlegget: notat/METODEBESKRIVELSE_kort_2026-09-21.md (NRKs modell etterprøvd, data, fire ledd, estimering, kontroller, mekanisme, aggregering, forbehold). Lagt inn som spor endringer (forfatter Claude, 21.09) direkte i «OneDrive - Oslo Economics AS/260913 utkast notat til NRK.docx»: 10 gamle metodeavsnitt slettet (inkl. 4 nummererte), 12 nye satt inn (4 nummererte), avsnittet «Bestillerne er annerledes» utelatt fordi utkastet har egen del om det. pack.py validert, 0 lang tankestrek. OneDrive-versjonen inneholdt ingen av 20.09-endringene (0 ins/0 del før redigering); de må ev. legges inn på nytt. Signaturen «Siviløkonom» skal stå – Jakob er både siviløkonom og samfunnsøkonom (korrigert 21.09), så 20.09-endringen av tittel var feil.
- Spesifikasjonen (ligning med symbolforklaring, bootstrap-detaljer) lagt inn som tre nye spor-endrings-avsnitt etter de fire leddene, i OneDrive-utkastet og i notat/METODEBESKRIVELSE_kort_2026-09-21.md. Pakking valideres nå mot pristine.docx (scratchpad) fordi --original ikke kan være en fil som allerede har Claudes endringer.
- Sluttkorrektur av leserinnlegget som spor endringer i OneDrive-utkastet (forfatter Claude, 21.09 15:30): norgespris med liten forbokstav utenom setningsstart (Språkrådet: offentlig støtteordning, som barnetrygd; sprakradet.no/spraksporsmal-og-svar/norgespris/), «hu»-skrivefeil, «ennå ikke eksisterte», «Elhubs egen analyse … viste», «ledd 4», «noe som gjør», signaturen bare under innlegget («siviløkonom» med liten s), fem avsnitt strammet (1, 3, 5, 11, 32). 1 473 → 1 400 ord. Validert mot pristine2.docx; 0 lang tankestrek. Tallene uendret.
- Lesbarhetskritikk (kritiker-agent, opus) av den godtatte teksten, silt: 5 hovedpunkter + småting lagt inn som spor endringer (forfatter Claude, 21.09 17:00) i OneDrive-utkastet: frivillighet forklart, ingress skiller 3 (bestillere) fra 2–3 (alle), placebotest eget avsnitt uten utropstegn, innvending stilt før den besvares, avslutning uten betinget «den», tittel «bommer på», «sene bestillere», «som om», «fritidsboliger i Sør-Norge», e(g,t) forklart, ledd 4 omskrevet, 10 mot 8 prosent kommentert, NRKs andel-funn omtalt (Privat-andel signifikant 0,16–0,24, husholdningsandel 0,083 n.s.). Kritikerens kommaforslag avvist (leddsetning foran hovedverb). Kontrollert mot kilder/nrk_prisen_for_billig_strom.md: 27.08, «over åtte prosent», sammenfaller, kommunedata fra Elhub, fire koeffisienter + R2 93,76, vannmagasiner – alt stemmer. 1 400 → 1 567 ord. Validert mot pristine2.docx, 0 lang tankestrek.
- Innlegget strammet til hovedpoenget (spor endringer, Claude 21.09 18:00): vannmagasin-leddet ut av ingressen, «i hovedsak de samme kildene», 15-prosent-avsnittet flyttet til metodedelen som «Forbruket samlet.», «Ingen modell er perfekt»-avsnittet slettet (gjentok avsnitt 5), avslutningen kortet. Validert mot pristine2.docx, 0 lang tankestrek.
- 22.09: Moxnes' Facebook-innlegg (etter Helgemorgen 19.09) ettergått mot SSB 14091 (årssummer 2010–2026, ny tabell output/tab_elbalanse_aar_2010_2026.csv), SSB 09387 (kraftpris husholdninger 2012–2026), NVE magasin/tilsig og Statnett. Funn i TIL_GODKJENNING.
- 23.09: NRKs svar (fritidsboliger, «ikke slått fast årsakssammenheng») vurdert. Elhub-kommunefilen har bare «Privat», så vår NRK-replikasjon inkluderer hytter som NRK; hytter 6 prosent av volumet, vekst 22 mot 14 prosent jan–jun, bidrag om lag 0,5 pp. Tall i TIL_GODKJENNING.
- 23.09: hyttetest i kommunepanelet (M1 med post×hytteandel og delutvalg): NRK-lik effekt 8,7 prosent i kommuner med lav hytteandel, 11,2 med høy, placebo om lag 5 i alle. Ad hoc-kjøring fra src (ikke eget skript); tall i TIL_GODKJENNING.
- 23.09: src/s22_hytteandel.py (lagt i run_all): post × hytteandel med gradvis flere kontroller. Utslaget faller fra 1,4 til 0,4–0,8 prosent per 10 pp når hver kommune får egen sesongprofil; placebo om lag null. Tall i TIL_GODKJENNING.
